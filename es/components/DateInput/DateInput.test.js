...
describe('<DateInnput />', function () {
  var onChange = jest.fn();
  beforeEach(function () {
    onChange.mockReset();
  });
  it('should render pass correct props to the inners components', function () {
    var wrapper = mount(___EmotionJSX(DateInput, {
      value: "2018-11-07",
      onChange: onChange
    }));
  ...
  it('should render pass correct props to the inners components in time mode', function () {
    var wrapper = mount(___EmotionJSX(DateInput, {
  ...
  it('should coorect update local value state', function () {
    var wrapper = mount(___EmotionJSX(DateInput, {
      value: "2018-11-07",
      onChange: onChange
    }));
  ...
  it('should pass null to datepicker on incorrect value', function () {
    var wrapper = mount(___EmotionJSX(DateInput, {
  ...
  it('should call oChange callback on change datepicker', function () {
    var wrapper = mount(___EmotionJSX(DateInput, {
      value: "2018-11-07",
      onChange: onChange
    }));
  ...
  it('should call oChange callback on change input', function () {
    var wrapper = mount(___EmotionJSX(DateInput, {
      value: "2018-11-07",
      onChange: onChange
    }));
  ...
  it('should return null on incorrect typed date in the input', function () {
    var wrapper = mount(___EmotionJSX(DateInput, {
      value: "2018-11-07",
      onChange: onChange
    }));
  ...
  it('should pass null on not exist value', function () {
    var wrapper = mount(___EmotionJSX(DateInput, {
      value: undefined,
      onChange: onChange
    }));
  ...
  it('should call onChange with null on not exist value', function () {
    var wrapper = mount(___EmotionJSX(DateInput, {
      value: undefined,
      onChange: onChange
    }));
